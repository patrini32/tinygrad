...
class ClangJITCompiler(Compiler):
  ...
  def compile(self, src:str) -> bytes:
    ...
    args = ['-march=native', (f'--target=x86_64-w64-windows-gnu' if WIN else f'--target={platform.machine()}-none-unknown-elf'), '-O2', '-fPIC', '-ffreestanding', '-fno-math-errno', '-nostdlib']
